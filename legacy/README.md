...
It is intentionally left as-is. The typed, tested implementation lives in
[`../src/haploqtl/`](../src/haploqtl/); the test suite checks it against this reference
script — identical clustering partitions wherever the merge-distance agrees.
