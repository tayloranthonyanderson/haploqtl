# Interpreting candidate genes for quantitative disease resistance
...
- A diagnostic marker (`diagnostic_variants.py`) carries an allele present in all resistant donors and absent from all susceptible controls — i.e. it tracks the introgressed haplotype.
